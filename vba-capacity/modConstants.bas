...
Public Const COL_OPER_CODE As String = "OperCode"
Public Const COL_OPERATION_NAME As String = "OperationName" ' Legacy; prefer OperCode
Public Const COL_MADE_IN_FFA As String = "MadeInFFA"
Public Const COL_USE_AVG_HOURS As String = "UseAvgHours"
Public Const COL_USE_AVG_EX As String = "UseAvgEx"
Public Const COL_SHOW_AVG_HOURS As String = "ShowAvgHours" ' Legacy; prefer UseAvgHours
Public Const COL_SHOW_AVG_EX As String = "ShowAvgEx" ' Legacy; prefer UseAvgEx
Public Const COL_PROCESS_HOURS As String = "ProcessHours"
Public Const COL_MANUAL_AVG_EX As String = "ManualAvgEx"
Public Const COL_BATCH_SIZE As String = "BatchSize"
...
Public Const PE_COL_DASH As Long = 9
Public Const PE_COL_SEPARATOR As Long = 10
...
Public Const PE_COL_OPER_CODE As Long = 8
...
Public Const PE_COL_USE_AVG_HOURS As Long = 15
Public Const PE_COL_USE_AVG_EX As Long = 16
