...
Public Const FFAS_SHEET_NAME As String = "FFAs"
Public Const PRODUCT_LINES_SHEET_NAME As String = "ProductLines"
Public Const PART_DASH_CONDITIONS_SHEET_NAME As String = "PartDashConditions"
Public Const PART_FFAS_SHEET_NAME As String = "PartFFAs"
Public Const PART_PRODUCT_LINES_SHEET_NAME As String = "PartProductLines"
...
Public Const FFAS_TABLE_NAME As String = "FFAsTbl"
Public Const PRODUCT_LINES_TABLE_NAME As String = "ProductLinesTbl"
Public Const PART_DASH_CONDITIONS_TABLE_NAME As String = "PartDashConditionsTbl"
Public Const PART_FFAS_TABLE_NAME As String = "PartFFAsTbl"
Public Const PART_PRODUCT_LINES_TABLE_NAME As String = "PartProductLinesTbl"
...
Public Const COL_FFA_CODE As String = "FFACode"
Public Const COL_FFA_NAME As String = "FFAName"
Public Const COL_PRODUCT_LINE_CODE As String = "ProductLineCode"
Public Const COL_PRODUCT_LINE_NAME As String = "ProductLineName"
