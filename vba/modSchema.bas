...
Public Const FFA_VALUE_COLUMN As String = "C"
Public Const FFA_CHECKBOX_COLUMN As String = "D"
...
Public Const COL_PARTS_FFAS As String = "FFAs"
...
Public Const UI_SCHEMA_VERSION As String = "1"
...
Public Const EXPORT_LAST_COLUMN As Long = 10
Public Const EXPORT_COLUMN_COUNT As Long = 8
